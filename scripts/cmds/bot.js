...
if ((event.body.toLowerCase() == " bot love you") || (event.body.toLowerCase() == "i love you")) {
   ...
   if ((event.body.toLowerCase() == "bot ji ") || (event.body.toLowerCase() == "baby")) {
     return api.sendMessage("️Chal hat", threadID, messageID);
   };
...
if ((event.body.toLowerCase() == "🤬") || (event.body.toLowerCase() == "🤬")) {
  ...
  if ((event.body.toLowerCase() == "meri zaindagi") || (event.body.toLowerCase() == "mera payar")) {
   ...
   if ((event.body.toLowerCase() == "Hello") || (event.body.toLowerCase() == "hi")) {
     return api.sendMessage("Next Hi/Hello nhi Assalamualaikum Bola kro Okay 💖 MIAN AMIR", threadID);
   };
...
if ((event.body.toLowerCase() == "Boss") || (event.body.toLowerCase() == "boss")) {
     return api.sendMessage("MIAN AMIR 🙊🙈", threadID, messageID);
   };
...
if ((event.body.toLowerCase() == "Hi") || (event.body.toLowerCase() == "hi")) {
  ...
  if ((event.body.toLowerCase() == "Cuteness") || (event.body.toLowerCase() == "cuteness")) {
     return api.sendMessage("Amir ki hai Yawr🥺", threadID);
   };
  
  if ((event.body.toLowerCase() == "Hacker") || (event.body.toLowerCase() == "hacker")) {
     return api.sendMessage("𝐘𝐑 𝐓𝐀𝐍𝐆 𝐍𝐇𝐈 𝐊𝐑𝐎 𝐌𝐀𝐑𝐘 𝐁𝐎𝐒𝐒 𝐇𝐀𝐂𝐊𝐄𝐑 𝐊𝐎___🚫😛❌", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "vini") || (event.body.toLowerCase() == "vïñî")) {
     return api.sendMessage("𝐘𝐑 𝐓𝐀𝐍𝐆 𝐍𝐇𝐈 𝐊𝐑𝐎 𝐌𝐀𝐑𝐈 𝐁𝐎𝐒𝐒 vïñî 𝐊𝐎 😈🙄", threadID);
   };
